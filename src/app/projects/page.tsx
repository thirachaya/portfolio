      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
          ...
          <div className="p-6">
            <h3 className="font-semibold text-xl mb-2 text-gray-800">
              Blew Noxs | Content Publishing Platform
            </h3>
            ...
            <p className="text-gray-600 mb-4 text-sm leading-relaxed">
              A basic blog editor with a rich text editing experience using
              Tiptap. Built with Next.js, PostgreSQL, and TailwindCSS,
              supporting post creation and publishing.
            </p>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="text-xs bg-emerald-100 text-teal-800 px-2 py-1 rounded-md">
                Next.js
              </span>
              <span className="text-xs bg-emerald-100 text-teal-800 px-2 py-1 rounded-md">
                Tiptap Editor
            ...
            <div className="flex gap-3">
              <a
                ...
                className="text-sm font-medium text-white bg-gradient-to-r from-sky-700 to-emerald-500 px-4 py-2.5 rounded-lg hover:from-sky-600 hover:to-emerald-400 transition-all duration-300 w-full text-center shadow-md hover:shadow-lg"
              >
                View Live Demo
              </a>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col">
          ...
          <div className="p-6 flex-grow flex flex-col">
            <h3 className="font-semibold text-xl mb-2 text-gray-800">
              Finora Wealth Lab | Money Tracker and Management
            </h3>
            <div className="flex gap-2 mb-3">
            ...
            <p className="text-gray-600 mb-4 text-sm flex-grow">
              Exploring new technologies to solve real-world problems. Stay
              tuned for updates!
            </p>
          </div>
        </div>
